package com.glotms.emailservice.utils;
...
public class LoggingAspect {
	...
	@Around("execution(* com.glotms.emailservice.service.*.*(..))")
	...
	@AfterThrowing(pointcut = "execution(* com.glotms.emailservice.*.*.*(..))", throwing = "error")
